...
/* 
	Použitá knihovna pro výpočet otisku md5 neobsahuje hlavičkový soubor. Je tedy použít 
...
/**
 * @brief Zkontroluje, zda se md5 otisk zadaného hesla shoduje s VALID_PASSWORD_HASH.
 * @param password Zadané heslo.
...
int main() {
	...
	password[strlen(password) - 1] = '\000';		/* Odstraním \n z konce řetězce. Je tohle v pořádku? */
